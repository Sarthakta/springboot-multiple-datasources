...
@EnableJpaRepositories(basePackages = "com.example.demo.users",entityManagerFactoryRef = "usersEntityManagerFactory", transactionManagerRef = "usersTransactionManager")
public class UsersDBConfig {
    ...
    LocalContainerEntityManagerFactoryBean usersEntityManagerFactory(
        ...
        return builder.dataSource(usersDatasource).properties(properties).packages("com.example.demo.users").build();
    }
}