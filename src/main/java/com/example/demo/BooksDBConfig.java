...
@EnableJpaRepositories(basePackages = "com.example.demo.books",entityManagerFactoryRef = "booksEntityManagerFactory", transactionManagerRef = "booksTransactionManager")
public class BooksDBConfig {
    ...
    LocalContainerEntityManagerFactoryBean booksEntityManagerFactory(
        ...
        return builder.dataSource(bookssDatasource).properties(properties).packages("com.example.demo.books").build();
